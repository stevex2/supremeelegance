...
!function(window, $, undefined){
	...
	jBar.prototype = {
		...
		createButton: function () {
			if (this.jsonConfig.button && this.jsonConfig.url && this.jsonConfig.target) {
				this.$elem.children('.jbar-wrap').append(
					$('<a href="' + this.jsonConfig.url + '" class="jbar-button" target="' + this.jsonConfig.target + '">' + this.jsonConfig.button + '</a>')
				)
			}
			return this
		},
