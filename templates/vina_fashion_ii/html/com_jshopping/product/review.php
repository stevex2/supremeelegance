    ...
    <?php if ($this->allow_review > 0){?>
        ...
        <div id="jshop_review_write">
            <div class="row-fluid">
                ...
                <div class="span9">
                    <input type="text" name="user_name" id="review_user_name" class="inputbox" style="width:50%;min-height: 35px;" value="<?php print $this->user->username?>"/>
                </div>
            </div>
            <div class="row-fluid">
                <div class="span3">
                ...
                <div class="span9">
                    <input type="text" name="user_email" id="review_user_email" class="inputbox" style="width:50%;min-height: 35px;" value="<?php print $this->user->email?>" />
                </div>
            </div>
            <div class="row-fluid">
                <div class="span3">
           ...
           <div class="row-fluid">
            ...
            <div class="row-fluid">
                <div class="span3"></div>
                <div class="span9">
                    <input type="submit" class="submit_review button validate" value="<?php print _JSHOP_REVIEW_SUBMIT?>" />
                </div>
            </div>
        </div>
        </form>
